...
class MyHTTPRequestHandler(SimpleHTTPRequestHandler):
    ...
    def reset(self, content, path):
        ...
        if ((playerData1["reset"] == "True" and playerData2["reset"] == "True") or (
                playerData1["reset"] == "True" and playerData2['name'] == path[2]) or (
                playerData2["reset"] == "True" and playerData1['name'] == path[2])):
    ...
    def Exit_game(self, content, path):
        if (os.path.exists("www/player1.json")):
            pf1 = open("www/player1.json", 'r+')
            playerData1 = json.load(pf1)
        if (os.path.exists("www/player2.json")):
            pf2 = open("www/player2.json", 'r+')
    ...
    def playResult(self):
        if (os.path.exists("www/player1.json") and os.path.exists("www/player2.json")):
            ...
            if (playerData1["throw"] != '' and playerData2["throw"] != ''):
                ...
                return "Still waiting on other player throw"
        else:
